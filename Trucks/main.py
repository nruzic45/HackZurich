...
class TextAndCanvasApp(QWidget):
    ...
    def initUI(self):
        ...
        main_layout.addWidget(self.text_label2)
        ...
        self.input_cities = []
        self.values = []
        self.to_front_Inbound = ""
        self.to_front_Outbound = ""
    ...
    def clear_canvas(self):
        ...
        self.to_front_Inbound = "Inbound sources: " + self.array_to_string(res1[0]) + " Percantage: " + self.array_to_string(res1[1])
        self.to_front_Outbound = "Outbound factories: " + self.array_to_string(res2[0])
        print(self.to_front_Inbound)
        print(self.to_front_Outbound)


        self.text_label.setText(self.to_front_Inbound)
        self.text_label2.setText(self.to_front_Outbound)
